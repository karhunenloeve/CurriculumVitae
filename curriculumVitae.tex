...
\years{2024--25} Private tutor in Mathematics and German.
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hangparas}
	{1em}{1} \years{2024 \href{https://karhunenloeve.github.io/FunkanaFredholm/main.pdf}{\faFilePdfO} \href{https://arxiv.org/pdf/2410.08323}{\aiarXiv}} \textbf{Luciano Melodia}: Beschränkte Fremdholmoperatoren und deren Fremdholmindex auf separablen Hilberträumen. Graduate Seminar on Spectral Flow in Functional Analysis, Friedrich-Alexander Universität Erlangen-Nürnberg.
\end{hangparas}
%
\begin{hangparas}
