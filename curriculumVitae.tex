...
\begin{itemize}[noitemsep, leftmargin=*]
	...
	\item Computer Science:
		\begin{itemize}[noitemsep, leftmargin=*]
			...
			\item European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases 2020
			\item European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases 2019
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hangparas}
	{1em}{1} \years{2025 \href{https://karhunenloeve.github.io/SpecSeq/main.pdf}{\faFilePdfO}} \textbf{Luciano Melodia}: Spektrale Sequenzen - Leray-Serre spektrale Sequenz. Graduate Seminar on Spectral Theory in Mathematical Physics, \\ \underline{Friedrich-Alexander Universität Erlangen-Nürnberg}.
\end{hangparas}
%
\begin{hangparas}
