...
\section*{Professions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\years{2024--25} Private tutoring in German and mathematics.
\begin{itemize}
...
\end{itemize}
\years{2023--24} Student assistant Algebra and Geometry, Representation Theory and Operator Algebras, FAU\footnote{Friedrich-Alexander University Erlangen-Nürnberg.}.
\begin{itemize}
