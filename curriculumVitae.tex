...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hangparas}
	{1em}{1} \years{2024 \href{https://karhunenloeve.github.io/BscMath/main.pdf}{\faFilePdfO} \href{https://arxiv.org/pdf/2410.08323}{\aiarXiv}} \textbf{Luciano Melodia}: Algebraic and Topological Persistence. Bachelor thesis. Friedrich-Alexander Universität Erlangen-Nürnberg.
\end{hangparas}
%
\begin{hangparas}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hangparas}
	{1em}{1} \years{2024 \href{https://karhunenloeve.github.io/FunkanaFredholm/main.pdf}{\faFilePdfO}} \textbf{Luciano Melodia}: Beschränkte Fremdholmoperatoren und deren Fremdholmindex auf separablen Hilberträumen. Graduate Seminar on Spectral Flow in Functional Analysis, Friedrich-Alexander Universität Erlangen-Nürnberg.
\end{hangparas}
%
\begin{hangparas}
